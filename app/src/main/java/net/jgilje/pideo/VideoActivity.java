...
public class VideoActivity extends AppCompatActivity {
     ...
     * Log tag
     */
    private static final String TAG = "VideoActivityOld";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContentView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
                if (player == null) {
                    player = new Player(holder.getSurface(), serverHost, serverPort);
                    player.setEventListener(new Player.EventListener() {
                        @Override
                        public void onSync() {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    builder.setTitle(R.string.connection_failed)
                                            .setMessage(R.string.failed_to_connect)
                        ...
                        public void onConnectionFailed() {
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(VideoActivity.this);
                                    builder.setTitle(R.string.connection_failed)
                                            .setMessage(R.string.connection_aborted)
                                            .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                                @Override
                                                public void onClick(DialogInterface dialog, int which) {
                                                    finish();
        ...
        findViewById(R.id.button_disconnect).setOnTouchListener(mDelayHideTouchListener);
